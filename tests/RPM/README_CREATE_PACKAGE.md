...
X	libQt5Core.so.5()(64bit) is needed by lrose-blaze-20180516.x86_64
X	libQt5Core.so.5(Qt_5)(64bit) is needed by lrose-blaze-20180516.x86_64
X	libQt5Core.so.5(Qt_5.9)(64bit) is needed by lrose-blaze-20180516.x86_64
X	libQt5Gui.so.5()(64bit) is needed by lrose-blaze-20180516.x86_64
X	libQt5Gui.so.5(Qt_5)(64bit) is needed by lrose-blaze-20180516.x86_64
X	libQt5Network.so.5()(64bit) is needed by lrose-blaze-20180516.x86_64
X	libQt5Widgets.so.5()(64bit) is needed by lrose-blaze-20180516.x86_64
X	libQt5Widgets.so.5(Qt_5)(64bit) is needed by lrose-blaze-20180516.x86_64
	libX11.so.6()(64bit) is needed by lrose-blaze-20180516.x86_64
	libXext.so.6()(64bit) is needed by lrose-blaze-20180516.x86_64
X	libfftw3.so.3()(64bit) is needed by lrose-blaze-20180516.x86_64
X	libgfortran.so.3()(64bit) is needed by lrose-blaze-20180516.x86_64
X	libgfortran.so.3(GFORTRAN_1.0)(64bit) is needed by lrose-blaze-20180516.x86_64
X	libjasper.so.1()(64bit) is needed by lrose-blaze-20180516.x86_64
X	libpng15.so.15()(64bit) is needed by lrose-blaze-20180516.x86_64
X	libquadmath.so.0()(64bit) is needed by lrose-blaze-20180516.x86_64  (in gcc?)
```

Ok, I need to install the dependencies in the clean container ...

### Q: Is there a way to have RPM install all the dependencies?

```
$ rpm -qp --requires lrose-blaze..rpm
$ rpm -qp --provides lrose-blaze..rpm
...
inside rpm spec file ...

Requires:
Provides:
```

These are eliminated by the automatic dependency generatation that has been added to rpm builder.


### Try installing rpm into alternate location (TODO)

```
rpm --root /alt/install/path ...
```
...
try   /usr/local/lrose/bin/HawkEye 
```

[root@a91a80359048 bj]# /usr/local/lrose/bin/HawkEye   
QStandardPaths: XDG_RUNTIME_DIR not set, defaulting to '/tmp/runtime-root'
ERROR - ColorMap::readXmlMap
  Cannot open color map file: /usr/local/lrose/bin/../share/color_scales/dbz.colors
No such file or directory
ERROR - ColorMap::readRalMap
  Cannot open color map file: /usr/local/lrose/bin/../share/color_scales/dbz.colors
No such file or directory
ERROR - HawkEye::_setupDisplayFields()
  Cannot read in color map file: /usr/local/lrose/bin/../share/color_scales/dbz.colors

Q: Where are the colorscale files???
Are they in the build container? No. 
Need the color maps ...

[root@c0ffa6d61fb0 lrose-blaze-20180516.src]# ls
LICENSE.txt  README.md  ReleaseInfo.txt  build  build_src_release.py  codebase  create_bin_release.py  docs  lrose-netcdf  release_notes  share
[root@c0ffa6d61fb0 lrose-blaze-20180516.src]# ls share
color_scales
[root@c0ffa6d61fb0 lrose-blaze-20180516.src]# grep -r color_scales *
build/checkout_and_build_auto.py:    shellCmd("rsync -av color_scales " + shareDir)
build/create_src_release.py:    displaysDir = os.path.join(tmpDir, "lrose-displays/color_scales")
codebase/apps/radar/src/HawkEye/HawkEye.rhi_sim:color_scale_dir = "$(PROJ_DIR)/display/color_scales";
codebase/apps/radar/src/HawkEye/HawkEye.sim:color_scale_dir = "$(PROJ_DIR)/display/color_scales";
codebase/apps/radar/src/HawkEye/HawkEye.nexrad:color_scale_dir = "$(HOME)/git/lrose-displays/color_scales";
codebase/apps/radar/src/HawkEye/HawkEye.hcr:color_scale_dir = "$(PROJ_DIR)/display/color_scales";
codebase/apps/radar/src/HawkEye/HawkEye.ops:color_scale_dir = "$(PROJ_DIR)/display/color_scales";
codebase/apps/radar/src/HawkEye/HawkEye.images.ppi:color_scale_dir = "$(PROJ_DIR)/display/color_scales";
codebase/apps/radar/src/HawkEye/Args.cc:    } else if (!strcmp(argv[i], "-color_scales")) {
codebase/apps/radar/src/HawkEye/Args.cc:      << "       [ -color_scales ? ] specify color scale directory\n"
codebase/apps/radar/src/HawkEye/HawkEye.archive.ppi:color_scale_dir = "$(PROJ_DIR)/display/color_scales";
codebase/apps/radar/src/HawkEye/Params.cc:    tt->single_val.s = tdrpStrDup("../share/color_scales");
codebase/apps/radar/src/HawkEye/HawkEye.archive.bscan:color_scale_dir = "$(HOME)/git/HCR_configuration/projDir/display/color_scales";
codebase/apps/radar/src/HawkEye/paramdef.HawkEye:  p_default = "../share/color_scales";
codebase/apps/radar/src/HawkEye/HawkEye.archive.rhi:color_scale_dir = "$(PROJ_DIR)/display/color_scales";
codebase/apps/radar/src/HawkEye/HawkEye.bscan:color_scale_dir = "$(PROJ_DIR)/display/color_scales";
codebase/apps/radar/src/HawkEye/HawkEye.test:color_scale_dir = "../share/color_scales";
Binary file codebase/apps/radar/src/HawkEye/.libs/HawkEye matches
codebase/apps/radar/src/HawkEye/HawkEye.hsrl:color_scale_dir = "$(PROJ_DIR)/display/color_scales";
Binary file codebase/apps/radar/src/HawkEye/Args.o matches
Binary file codebase/apps/radar/src/HawkEye/Params.o matches

The color_scales are not added when using build_src_release.py

from build/checkout_and_build_auto.py ...
# perform install
...
---- 
just add this to the build_src_release.py script ...
 calls build/build_lrose.py 
